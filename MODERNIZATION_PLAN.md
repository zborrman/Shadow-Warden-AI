...
- ⏭️ Осталось в Фазе 1: 1.1 (единый auth-middleware, `X-Tenant-Tier` вне контура доступа), 1.4 (IDOR-хелпер). Осталось в Фазе 2: 2.3 (пиннинг валидированного IP — TOCTOU), 2.4 (CORS `/ext/*`). Далее — Фаза 3 (корректность рантайма).
