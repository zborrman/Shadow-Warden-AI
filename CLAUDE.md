...
- **Site version**: `v5.6` across all Astro components. Layer count: `15`. `/analytics` page (AI Analytics Hub) at `site/src/pages/analytics.astro`. `/roadmap` has 28 shipped + 3 planned features. `WhatsNew.astro` shows v5.6 Latest (Community Marketplace / Event Notifications / Deploy Monitoring / SDK) / v5.3 Previous / v5.2 / v5.1 / v4.20.
