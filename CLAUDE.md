...
| `warden/finops/llm_budget.py` | Per-tenant monthly LLM allowance + soft model gate (FM-7) — `tier_llm_budget_usd`, `mtd_spend_usd`, `budget_status`, `choose_model` (fail-open, never below `candidates[0]`), `margin_report` |
...
- **Tier prices**: Starter $0 (1k req), Individual $5/mo (5k req), Community Business $39.99/mo (10k req, File Scanner + Shadow AI Monitor + 3 communities×10 members + 180-day retention), Pro $99.99/mo (50k req, MasterAgent included), Enterprise $249/mo (unlimited, PQC + Sovereign). Add-ons: `shadow_ai_discovery` +$15/mo (Pro+), `xai_audit` +$9/mo (Individual+). MasterAgent is included in Pro — **not sold as an add-on**.
