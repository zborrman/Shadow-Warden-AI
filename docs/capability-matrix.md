...
| Escrow with 48h delivery timeout | `SIMULATED` | Same endpoint reports `"settlement_mode": "simulated"`. The state machine runs; no value moves. | Label every escrow claim "simulated" until P1a |
